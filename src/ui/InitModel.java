...
public class InitModel {
    public ArrayList<Vehicle> createVehicles() {
        ...
        //First vehicle 
        Vehicle vehicle0 = new ElectricCar(100000, "Audi", "2015", 1.5, 200000, TypeVehicle.NEW, "JOY 132", 4, true, TypeCar.SEDAN, 25, TypeCharger.NORMAL);
        ...
        //Second vehicle
        Vehicle vehicle1 = new GasolineCar(100000, "Mercedes", "2014", 8.9, 2000, TypeVehicle.USED, "HMP 222", 5, false, TypeCar.PICKUP_TRUCK, 50, TypeGasoline.EXTRA);
        ...
        //Fourth vehicle
        Vehicle vehicle3 = new HybridCar(1000, "Renault", "2020", 1.0, 45000, TypeVehicle.USED, "CUM 123", 5, false, TypeCar.SEDAN, 20.0, 10.0, TypeCharger.FAST, TypeGasoline.REGULAR);
